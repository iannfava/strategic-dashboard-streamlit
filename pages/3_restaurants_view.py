...
def avg_std_time_delivery(df1, Festival, op):
    """
       This function calculates the average time e standard deviation of delivery time
       parameters:
          Input:
            -df:Dataframe with data for the calculation
            -op:Type of operation to be calculated 
